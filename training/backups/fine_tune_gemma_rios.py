...
def main():
    ...
    # print('tokenizer')
    # SET UP TOKENIZER
    tokenizer = AutoTokenizer.from_pretrained(model_id, add_bos_token=True, add_eos_token=True, ) # <bos>blah <eos> 
    ...
    train['rel_prompt'] = generate_context_prompt(train, context_prefix_text, 'relevant_context')
    train['rand_prompt'] = generate_context_prompt(train, context_prefix_text, 'random_context')
    train['wd_prompt'] = generate_context_prompt(train, context_prefix_text, 'wrong_date_context')
    
    dev['no_prompt'] = generate_no_context_prompt(dev, no_context_prefix_text)
    dev['rel_prompt'] = generate_context_prompt(dev, context_prefix_text, 'relevant_context')
    dev['rand_prompt'] = generate_context_prompt(dev, context_prefix_text, 'random_context')
    dev['wd_prompt'] = generate_context_prompt(dev, context_prefix_text, 'wrong_date_context')
