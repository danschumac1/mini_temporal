...
base_models=("gemma-2b") # Add other models if needed
...
trained_contexts=("relevant_context" "no_context") # "relevant_context" "no_context" "random_context" "wrong_date_context"
  ...
  for base_model in "${base_models[@]}"; do
    ...
    for trained_context in "${trained_contexts[@]}"; do
      ...
      for eval_context in "${eval_contexts[@]}"; do
        ...
        CUDA_VISIBLE_DEVICES=1 python /home/dan/mini_temporal/generations/generations_nit_rios.py \
          --dataset ${dataset} \
